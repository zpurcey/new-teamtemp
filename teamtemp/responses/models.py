...
class TeamTemperature(models.Model):
    ...
    creator = models.ForeignKey(User, related_name="team_temperatures", on_delete=models.CASCADE)
...
class TeamResponseHistory(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    request = models.ForeignKey(TeamTemperature, related_name="team_response_histories", on_delete=models.CASCADE)
...
class Teams(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    request = models.ForeignKey(TeamTemperature, related_name="teams", on_delete=models.CASCADE)
    team_name = models.CharField(max_length=64, db_index=True)
