# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-06 05:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dept_names', models.CharField(default=b'DEPT,DEPT2', max_length=64)),
                ('region_names', models.CharField(default=b'REGION,REGION2', max_length=64)),
                ('site_names', models.CharField(default=b'SITE,SITE2', max_length=64)),
                ('default_tz', models.CharField(default=b'Australia/Queensland', max_length=64)),
