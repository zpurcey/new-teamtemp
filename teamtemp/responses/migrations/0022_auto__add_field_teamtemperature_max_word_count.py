...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamTemperature.max_word_count'
        db.add_column(u'responses_teamtemperature', 'max_word_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamTemperature.max_word_count'
        db.delete_column(u'responses_teamtemperature', 'max_word_count')
    ...
    models = {
        ...
        u'responses.teamtemperature': {
            ...
            'default_tz': ('django.db.models.fields.CharField', [], {'default': "'Australia/Queensland'", 'max_length': '64'}),
            ...
            'max_word_count': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
