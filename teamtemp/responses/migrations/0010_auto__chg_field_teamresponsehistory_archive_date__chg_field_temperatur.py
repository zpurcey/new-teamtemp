...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamResponseHistory.archive_date'
        db.alter_column(u'responses_teamresponsehistory', 'archive_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TemperatureResponse.archive_date'
        db.alter_column(u'responses_temperatureresponse', 'archive_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'TemperatureResponse.response_date'
        db.alter_column(u'responses_temperatureresponse', 'response_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'TeamResponseHistory.archive_date'
        db.alter_column(u'responses_teamresponsehistory', 'archive_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'TemperatureResponse.archive_date'
        db.alter_column(u'responses_temperatureresponse', 'archive_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'TemperatureResponse.response_date'
        db.alter_column(u'responses_temperatureresponse', 'response_date', self.gf('django.db.models.fields.DateField')(null=True))
