...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TemperatureResponse.archive_date'
        db.add_column(u'responses_temperatureresponse', 'archive_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TemperatureResponse.archive_date'
        db.delete_column(u'responses_temperatureresponse', 'archive_date')
