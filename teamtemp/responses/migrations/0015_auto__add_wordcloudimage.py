...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WordCloudImage'
        db.create_table(u'responses_wordcloudimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateField')()),
            ('word_list', self.gf('django.db.models.fields.CharField')(max_length=511)),
            ('image_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'responses', ['WordCloudImage'])


    def backwards(self, orm):
        # Deleting model 'WordCloudImage'
        db.delete_table(u'responses_wordcloudimage')
