...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamTemperature.survey_type'
        db.add_column(u'responses_teamtemperature', 'survey_type',
                      self.gf('django.db.models.fields.CharField')(default='TEAMTEMP', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamTemperature.survey_type'
        db.delete_column(u'responses_teamtemperature', 'survey_type')
